                        ...
                        <div id="edit_user">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td><input type="text" name="first_name" id="first_name" value="<?php echo $result[0]->name; ?>" /></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="email" id="email" value="<?php echo $result[0]->email;?>"/></td>
                                    
                                </tr>
                               
                                <tr>
                                    <td id="process_action" style="display: none;">saving...<div id="loading"></div></td>
                                    <td><input type="button" name="submit" id="user_submit" class="Button2 Button13 WhiteButton" value="submit" onclick="validate(<?php echo $result[0]->id;?>)"/></td>
                                </tr>
                                <tr>
...
function validate(id)
{
    ...
    $.ajax({
	        url: baseUrl+"admin/saveEditUser",
	        type: "POST",
	        data: val,
            dataType: 'json',
