            ...
            <div class="pop_content">
                <div id="pop_content">
                    <div class="right clsFloatRight" style="float:left;width:auto;">
                        <p>Are you sure to delete this account !. This action cannot be undo and all data associated with this account will get deleted!</p>
                        <p>Do you want to proceed</p>
                        <br clear="all">
                        <input type="button" class="Button2 Button13 WhiteButton" name="yes" value="yes" onclick="proceed('yes')"/>
                        <input type="button" class="Button2 Button13 WhiteButton" name="no" value="no" onclick="proceed('no')"/>
                        <br class="all">
                        <div id="process_action" style="display: none;">deleting...<div id="loading"></div></div>
                    </div>
                    <div class="clear"></div>
                </div>
